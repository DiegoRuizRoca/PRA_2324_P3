...
#include "/home/alumno.upv.es/druiroc/W/PRA/PRA_2324_P1/ListLinked.h"
...
template <typename V> class HashTable : public Dict<V> {
    ...
    public:
        ...
        friend std::ostream& operator<<(std::ostream &out, const HashTable<V> &th) {
            ...
            out << "HashTable [entradas: " << th.n << ", capacidad: " << th.max << "]" << endl;
        ...
        void insert(string key, V value) override {
            ...
            for(int i = 0; i < table[pos].size(); i++) {
                ...
                if(table[pos][i].key == key) throw runtime_error("La llave ya Existe");
        ...
        V search(string key) override {
            ...
            if(kValue == -1)throw runtime_error("Imposible encontrar la llave");
        ...
        V remove(string key) override {
            ...
            if(i == (table[pos].size())) throw runtime_error("Imposible encontrar la llave");
